...
class SessionModel {
  ...
  factory SessionModel.fromMap(Map<String, dynamic> map) {
    final List<dynamic> timeList =
        map[ModelConstant.timeSlots] as List<dynamic>;
    final List<Map<String, String>> timeSlots = timeList
        .map((slot) => Map<String, String>.from(slot as Map<String, dynamic>))
        .toList();
    ...
    return SessionModel(
      ...
      createdAt: map[ModelConstant.sessionCreatedAt] != null
          ? DateTime.parse(map[ModelConstant.sessionCreatedAt])
          : null,
      updatedAt: map[ModelConstant.sessionUpdatedAt] != null
          ? DateTime.parse(map[ModelConstant.sessionUpdatedAt])
          : null,
    );
  }
